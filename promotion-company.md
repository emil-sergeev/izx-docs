...
<img src="img\PCstep1.png" style="width:80%"/>
...
<img src="img\PCstep2.png" style="width:80%"/>
...
<img src="img\PCstep3rewardsList.png" style="width:80%"/>
...
Вам доступно поле ввода для своих промокодов с одним условием, новая строчка – новый промокод(т.е. каждый следующий промокод необходимо размещать с новой строки).
...
<img src="img\PCstep3rewardCreate.png" style="width:80%"/>
...
<img src="img\PCstep4.png" style="width:80%"/>
...
-   Изменять окончание исполнения РК через встроенный календарь.
После заполнения рекомендуем проверить введенные данные и отправить их на модерацию.

<img src="img\PCedit.png" style="width:80%"/>
